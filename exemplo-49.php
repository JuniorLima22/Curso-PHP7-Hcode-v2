...
<html lang="pt-br">
  <head>
    ...
    <title>Curso Udemy PHP 7 - Exemplo 49</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="page-header">
        <h1>PDO: Alterando dados no banco</h1>
      </div>
      ...
      <div class="panel panel-primary">
        <div class="panel-heading"><a href="" id="tiposBasicos"></a>PDO: Alterando dados no banco</div>
        <div class="panel-body">
          ...
          <div class='well well-sm'>
            ...
            Criar uma conexão com o Banco de Dados e Editar dados usando <code>PDO</code>.<br>
            ...
            <pre>
              <code class="php">
                ...
                $stmt = $conn->prepare("UPDATE tb_usuarios_dois SET deslogin = :LOGIN, dessenha = :PASSWORD WHERE idusuario = :ID");
            ...
            <?php
              echo "<strong>Resultado <code>UPDATE</code>:</strong> <br>";
