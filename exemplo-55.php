...
<html lang="pt-br">
  <head>
    ...
    <title>Curso Udemy PHP 7 - Exemplo 55</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading"><a href="" id="tiposBasicos"></a>INSERIR E LISTAR DADOS DA TABELA</div>
        <div class="panel-body">              

          <div class='well well-sm'>
            <strong>Condições: </strong> <br>
            Criar uma conexão com o Banco de Dados com <code>PDO</code> usando <code>DAO</code> e Inserir e Listar todos os Usuários da Tabela.<br>
            ...
            <pre><strong>procedure.sql</strong>
              <code class="php">
          ...
          <div class='well well-sm'>
            <pre><strong>Inclui e Lista Usuários da Tabela</strong>
              <code class="php">
            ...
            <?php
              echo "<strong>Resultado <code>Incluir e Listar Usuários da Tabela</code>:</strong> <br>";
