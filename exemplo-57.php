...
<html lang="pt-br">
  <head>
    ...
    <title>Curso Udemy PHP 7 - Exemplo 57</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading"><a href="" id="tiposBasicos"></a>DELETAR DADOS DA TABELA</div>
        <div class="panel-body">              

          <div class='well well-sm'>
            <strong>Condições: </strong> <br>
            Criar uma conexão com o Banco de Dados com <code>PDO</code> usando <code>DAO</code> e Deletar Usuários da Tabela.<br>
          ...
          <div class='well well-sm'>
            <pre><strong>Deletar Usuários da Tabela</strong>
              <code class="php">
                require_once("assets/dao/config.php");

                //Deletar Usuário na Tabela de Dados
                $usuario = new Usuario();
                $usuario->loadById(7);
                $usuario->delete();
            ...
            <?php
              echo "<strong>Resultado <code>Deletar Usuários da Tabela</code>:</strong> <br>";
